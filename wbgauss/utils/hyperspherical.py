# source: https://github.com/nicola-decao/s-vae-pytorch/blob/master/hyperspherical_vae/distributions/hyperspherical_uniform.py
import math
...
def log_radius(alpha, n):
    # Todo import this functiuon from spcdist
